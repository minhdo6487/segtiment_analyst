...
class measure_score:
    ...
    def value_of(cls, sentiment):
        print ('setiment: {}'.format(sentiment) )
    ...
    def sentence_score(cls, sentence_tokens, previous_token, acum_score):    
        if not sentence_tokens:
            ...
            for i_tag in tags:
                print "tag: {} --- score: {}".format(i_tag, measure_score.value_of(i_tag))
            print "previous_token: {}".format(previous_token)
            ...
            if previous_token is not None:
                ...
                if 'inc' in previous_tags:
                    token_score *= 2.0
                    print "inc in tag {}".format(token_score)
                elif 'dec' in previous_tags:
                    token_score /= 2.0
                    print "dec in tag {}".format(token_score)
                elif 'inv' in previous_tags:
                    token_score *= -1.0
                    print "inv in tag {}".format(token_score)

                print ("token_score: {}".format(token_score) )
...
if __name__ == "__main__":
    ...
    text = """
            this food is not very nice. But meat is good
            """
    # list_text = [
    #     "I like dog",
